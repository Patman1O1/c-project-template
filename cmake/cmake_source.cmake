...
if(EXISTS "${CMAKE_SOURCE_DIR}/src/${SOURCE_NAME}.c")
    message(NOTICE "${SOURCE_NAME}.c already exists")
    return()
endif()
...
if(EXISTS "${CMAKE_SOURCE_DIR}/include/${PROJECT_NAME}/${SOURCE_NAME}.h")
    # Let the user know that the associated header file already exists
    message(NOTICE "${SOURCE_NAME}.h already exists")
elseif(CREATE_HEADER)
    ...
    file(TOUCH "${CMAKE_SOURCE_DIR}/include/${PROJECT_NAME}/${SOURCE_NAME}.h")
    file(WRITE "${CMAKE_SOURCE_DIR}/include/${PROJECT_NAME}/${SOURCE_NAME}.h"
