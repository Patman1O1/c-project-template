...
def test__to_pascal_case__snake_case_string():
...
def test__to_pascal_case__camel_case_string():
...
def test__to_pascal_case__pascal_case_string():
    assert to_pascal_case("PascalCase") == "PascalCase"
    assert to_pascal_case("HelloWorld") == "HelloWorld"
    assert to_pascal_case("AbcEasyAs123Abc") == "AbcEasyAs123Abc"

def test__to_pascal_case__screaming_case_string():
